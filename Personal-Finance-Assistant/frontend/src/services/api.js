...
export const receiptAPI = {
    ...
    getHistory: (params) => api.get('/receipts/history', { params }),
    deleteLog: (id) => api.delete(`/receipts/history/${id}`),
};

// Upload API for transaction extraction
export const uploadAPI = {
    ...
    confirmTransactions: (data) => api.post('/upload/confirm', data),
};
