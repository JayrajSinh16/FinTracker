            ...
            <div className="card" style={{
                ...
                <div className="flex justify-between items-center">
                    <div style={{ flex: 1 }}>
                        ...
                        <p style={{ color: 'rgba(255,255,255,0.9)', marginBottom: '1rem', lineHeight: '1.5' }}>
                            Upload an image or PDF of your transaction table and let our AI extract and organize your data automatically.
                        </p>
                        <Link
                            to="/upload"
                            className="btn"
                    ...
                    <div style={{ fontSize: '4rem', opacity: 0.3, marginLeft: '2rem' }}>
                        📊
                    </div>
                </div>
            </div>
